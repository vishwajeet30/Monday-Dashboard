...
<script>
	...
	{
		document.domestic_form.flight_number.value = "";
		document.domestic_form.source_port1.value = "";
		document.domestic_form.source_country1.value = "";
		document.domestic_form.dest_port1.value = "";
		document.domestic_form.dest_country1.value = "";

		document.domestic_form.source_port.value = "";
		document.domestic_form.source_country.value = "";	
		document.domestic_form.dest_port.value = "";	
		document.domestic_form.dest_country.value = "";	
	
		document.domestic_form.action = "im_flight_routes_dashboard_03_domestic.jsp";
		document.domestic_form.submit();	
	}
...
<% String heading = "Domestic Flights in India"; %>
<br>
<div id="loading" name="loading/" style="background-color: #f5f9ff; ">
	...
	<h1 style="font-family: Arial;background-color: #D0DDEA; color: #347FAA; "><center>Domestic Flights in India</center></h1><br><br>
	<!--http://192.168.62.201:8889/Imm/vishwajeet/im_flight_routes_dashboard_05.jsp-->
	...
	%>
	<form action="" method="post" name="domestic_form">
	<table align="center" width="100%" border="0" cellspacing="0" cellpadding="2" bordercolorlight="#FF99CC" 
		...
		<td>
					<button type="submit" value="Submit" style="background-color: #004144;color: white;font-weight: bold; border: none;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 14px; margin: 4px 2px; cursor: pointer;">Submit</button>
